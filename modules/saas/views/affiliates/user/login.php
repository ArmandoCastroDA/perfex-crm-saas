            ...
            <div class="col-lg-4 col-md-6 col-12">
                <div class="card login-page shadow rounded border-0">
                    <div class="card-body">
                        ...
                        <?php echo form_open('affiliate/login', ['id' => 'register-form'], 'class="login-form mt-4"'); ?>
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <p class="forgot-pass mb-0"><a
                                                href="<?php echo base_url('auth/forgot-password'); ?>"
                            ...
                            <div class="col-12 text-center">
                                <p class="mb-0 mt-3"><small class="text-dark me-2">Don't have an account ?</small>
                                    <a href="<?php echo base_url('affiliate/become'); ?>"
                                       class="text-dark fw-bold btn btn-secondary btn-sm">Sign Up</a></p>
                            </div><!--end col-->
                        </div><!--end row-->
                        <?php echo form_close(); ?>
                    </div>
