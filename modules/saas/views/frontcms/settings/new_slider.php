...
?>
<?php
echo form_open_multipart('saas/frontcms/settings/save_slider/' . $id, array('id' => 'slider_form', 'class' => 'form-horizontal'));
?>
<div class="panel_s">
    <div class="panel-heading">
        <h4 class="panel-title"><?= _l('new') . ' ' . _l('slider') ?></h4>
    </div>
    <div class="panel-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <textarea name="description" class="form-control tinymce" rows="3"><?php
                    if (!empty($slider_info)) {
                        echo html_escape($slider_info->description);
                    } ?></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_text_1;
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_icon_1;
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_link_1;
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_text_2;
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_icon_2;
        ...
        <div class="form-group">
            ...
            <div class="col-lg-6">
                <input type="text" value="<?php
                if (!empty($slider_info)) {
                    echo $slider_info->button_link_2;
