<section class="section  bg-light">
    <div class="container">
        ...
        <div class="row">
            <?php $creatives_card_info = get_old_result('tbl_saas_all_section_area', array('type' => 'creatives', 'status' => 1));
                    ...
                    <div class="card explore-feature border-0 rounded text-center bg-white">
                        <div class="card-body py-5">
                            ...
                            <div class="progress-box mt-4">
                                ...
                                <div class="progress">
                                    <div class="progress-bar position-relative bg-primary"
                                         style="width:<?= $v_card_info->color_2 ? $v_card_info->color_2 : '-' ?>%;">
