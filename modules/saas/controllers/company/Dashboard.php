...
class Dashboard extends App_Controller
{
    ...
    public function index()
    {
        ...
        $data['states'] = $this->get_states($data['affiliate_info']);
    ...
    public function get_states($affiliate_info)
    {
        ...
        $states = [
            ...
            [
                ...
                'icon' => 'uil uil-wallet fs-24',
                'color' => 'warning',
                'count' => app_format_money($affiliate_info->total_balance - $affiliate_info->withdrawal_amount, $base_currency)
            ],
        ];
        return $states;
    }
    ...
    public function settings()
    {
        ...
        if (!empty($referral_link)) {
            ...
            $this->db->where('referral_link', $referral_link);
            ...
            if ($count > 0) {
                ...
                $this->form_validation->set_rules('referral_link', _l('referral_link'), 'required|is_unique[tbl_saas_affiliate_users.referral_link]');
